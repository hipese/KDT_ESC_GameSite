...
keyframes colorChange { 0% {
	filter: invert(16%) sepia(89%) saturate(6054%) hue-rotate(0deg)
...
@
keyframes open-modal-animation { 0% {
	transform: scale(0);
}
...
@
keyframes close-modal-animation { 0% {
	transform: scale(1);
}
...
<body>
	<div class="container-fluid">
		<div class="row header">
			...
			<div class="col-2 ">
				<a href="/"><img src="img/ESC HEADER.png" alt="" width="110px"
					height="50px"></a>
			</div>
				...
				<div id="carouselExampleSlidesOnly" class="carousel slide"
					...
					<div class="carousel-inner">
						...
						<div class="carousel-item">
							<div class="row">
								<div class="col-5">
									<img src="img/VampireSurvival.gif" class="d-block bannerimg"
										alt="...">
								</div>
								<div class="col-7">
									<div class="bannertext">
									...
									<br> 죽어서도 악마들을 퇴치하는 <br> 뼈다귀 마법사의 처절한 이야기<br>
									<br> <br>
									<div class="game2">
										<button class="playbutton">Play</button>
									</div>
						...
						<div class="carousel-item">
							<div class="row">
								...
								<div class="col-7">
									...
									<br> 404 Not Found가<br> 반가운 공룡의 이야기<br>
									<br> <br>
									<div class="game3">
										<button class="playbutton">Play</button>
									</div>
						...
						<div class="carousel-item">
							<div class="row">
								...
								<div class="col-7">
									...
									<br> 안전운전을 하고 싶지만 <br> 역주행 하는 차들을 피해 <br> 돈을 버는
									가장의 이야기 <br> <br>
									<div class="game4">
										<button class="playbutton">Play</button>
									</div>
						...
						<div class="carousel-item">
							<div class="row">
								...
								<div class="col-7">
									...
									<br> 조국을 지키기 위해서 <br> 백만 대군도 물리칠 수 있는 <br> 용감한
									사무라이! <br> <br>
									<div class="game5">
										<button class="playbutton">Play</button>
									</div>
						...
						<div class="carousel-item">
							<div class="row">
								<div class="col-5">
									<img src="img/RaiseDragon.gif" class="d-block bannerimg"
										alt="...">
								</div>
								<div class="col-7">
									<div class="bannertext">
									...
									<br> 드래곤의 알을 구해서 <br> 열심히 키워가지고 펫을 삼으려는 <br>
									아름다운 여전사의 이야기 <br> <br>
									<div class="game6">
										<button class="playbutton">Play</button>
									</div>
							...
							<div class="col-12 g-0">
								<form action="/login.members" method="post">
									<div class="loginbox">
										...
										<input type="url" class="url" name="url"
											style="display: none;" />
										<div class="check">
											<label for="chk"> <input type="checkbox" id="chk" />
												<i class="circle"></i> <span class="text">로그인 상태 유지</span>
											</label>
										</div>
									...
									<div class="row">
										<div class="col-12">
											<a href="/logout.members"><button type="button"
													class="mpbtn">로그아웃</button></a> <a href="/mypage.members"><button
													type="button" class="mpbtn">마이페이지</button></a>
										</div>
									</div>
								</div>
							</div>
		...
		<div class="row">
			<div class="col-2 d-lg-block d-none left">
				<div class="leftbox">
					...
					<ul>
						<a class="showBoardList" href="#" onclick='showBoardList()'>
							<li>게시판</li>
						</a>
				...
				<div class="row">
					...
					<div class="col-6 col-lg-4 gamebox g-0">
						<div class="game game2">
							<img src="img/VampireSurvival.gif" loop="infinite"
								class="gameimg gameimg2">
					...
					<div class="col-6 col-lg-4 gamebox g-0">
						<div class="game game4">
							<img src="img/cargame.gif" loop="infinite"
								class="gameimg gameimg4">
							<div class="gametitle">Drive Safely!</div>
						</div>
					</div>
					<div class="col-6 col-lg-4 gamebox g-0">
						<div class="game game5">
							<img src="img/samurai.gif" loop="infinite"
								class="gameimg gameimg5">
							<div class="gametitle">Samurai Game</div>
						</div>
					</div>
					<div class="col-6 col-lg-4 gamebox g-0">
						<div class="game game6">
							<img src="img/RaiseDragon.gif" loop="infinite"
								class="gameimg gameimg6">
	...
	<div id="login-modal" class="modal">
		<div class="modal-content">
			...
			<h2>Login</h2>
			<form action="/login.members" method="post">
				<label> <i class="fa fa-user"></i> <input type="text"
					id="username" placeholder="아이디" name="id"></label> <label>
					<i class="fa fa-lock"></i> <input type="password" id="password"
					placeholder="비밀번호" name="pw">
				</label> <input type="url" class="url" name="url" style="display: none;" />
				<input type="text" class="scroll" name="scroll"
					style="display: none;">
