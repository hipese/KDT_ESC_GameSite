...
<body>
                        ...
                        <c:otherwise>
                            <div class="col-12 g-0">
                                <div class="loginbox3">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <a href="/logout.members"><button type="button" class="mpbtn">로그아웃</button></a> <a href="/mypage.members"><button type="button" class="mpbtn">마이페이지</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div id="login-modal" class="modal">
        <div class="modal-content">
            ...
            <h2>Login</h2>
            <form action="/login.members" method="post">
                <label> <i class="fa fa-user"></i> <input type="text" id="username" placeholder="아이디" name="id"></label> <label>
                    <i class="fa fa-lock"></i> <input type="password" id="password" placeholder="비밀번호" name="pw">
